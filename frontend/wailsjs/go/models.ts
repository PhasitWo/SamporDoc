export namespace excel {
	...
	export class ControlDataWithRowCoordinate {
	    NO: number;
	    CustomerName: string;
	    Detail: string;
	    Amount: number;
	    ...
	    static createFrom(source: any = {}) {
	        return new ControlDataWithRowCoordinate(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.RowCoordinate = source["RowCoordinate"];
	    }
...
export namespace main {
	...
	export class CreateProcurementParams {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.OverwriteDeliveryNO = source["OverwriteDeliveryNO"];
	...
	export class CreateReceiptParams {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.OverwriteReceiptNO = source["OverwriteReceiptNO"];
	        this.CustomerName = source["CustomerName"];
	        this.CustomerID = source["CustomerID"];
	        this.Address = source["Address"];
	        this.Detail = source["Detail"];
